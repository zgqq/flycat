...
public class JavassistDispatcher {
    ...
    public static Class generateJobClass(Class<?> listenerInterface, Method method, int index) throws NotFoundException, CannotCompileException, ClassNotFoundException {
